...
//myFunction(); we can see in console both - "I'm outside the function", "Hello! I'm inside myFunction!"

/*🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: In each functions of Lexical environment, we can refer to the above Lexical environment. 
Since there is no internal value in nestedFunction(), the value is retrieved from myFunction() which is the global Lexical environment. 
In myFunction(), the same as nestedFunction(), there is no external value, it is referencing from const external. */
